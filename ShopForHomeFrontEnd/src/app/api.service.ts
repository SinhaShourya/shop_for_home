...
export class ApiService {
  ...
  adminregister(data: any) {
    return this.http.post<any>(this.BASEURL + 'admindemo', data);
  }
  ...
  updatestock(productid: any, data: any) {
    return this.http.put<any>(
      this.BASEURL + 'products/updatestock?productid=' + productid,
      data
    );
  }
  ...
  updateqty(cartid: number, qty: number) {
    return this.http.get<any>(
      this.BASEURL + 'cart/updateqty?cartid=' + cartid + '&qty=' + qty
    );
  }
